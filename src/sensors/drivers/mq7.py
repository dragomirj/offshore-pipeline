# *****************************************************************************
# Copyright (C) 2026 Dragomir J. - [SENSORS] MQ7 Sensor Driver
# *****************************************************************************
...
class MQ7Sensor(PolledSensor):
    """
    Hardware driver stub for the MQ7 carbon monoxide sensor.
    Channels : co_ppm (PPM)
    """

    REQUIRED_PARAMS:      frozenset[str] = frozenset({"adc_channel"})
    _REQUIRED_THRESHOLDS: frozenset[str] = frozenset({"co_ppm"})
    ...
    async def _setup(self) -> None:
        raise NotImplementedError(
            "MQ7Sensor._setup() not implemented. Use a simulated sensor class or provide a hardware-specific implementation."
        )

    async def _read_hardware(self) -> list[SensorReading]:
        raise NotImplementedError(
            "MQ7Sensor._read_hardware() not implemented. Use a simulated sensor class or provide a hardware-specific implementation."
        )
